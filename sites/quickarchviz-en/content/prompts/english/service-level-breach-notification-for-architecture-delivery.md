...
popular: false
what_it_does: |
  This prompt drafts a factual notification when an agreed response time, review window, service commitment, or deliverable date has been missed. It communicates accountability and corrective action while protecting professional relationships.
best_input: |
  Provide the missed commitment, source document, expected date, actual status, who is responsible, impact on project progress, corrective action, prevention measure, and intended recipient.
prompt: |
  ### SYSTEM ROLE
