...
image: "/sites/quickarchviz-en/AI-prompt-for-architects.png"
...
[QuickArchViz](https://quickarchviz.com/) focuses specifically on architectural workflows rather than generic AI imagery.
...
[Veras by EvolveLAB](https://www.evolvelab.io/veras) became popular because it connects AI visualization with familiar design environments, including Revit, SketchUp, Rhino, Forma, Archicad, and Vectorworks workflows.
...
Instead of disconnected plugins, platforms such as [SketchUp Diffusion](https://prod-aws-help.sketchup.com/en/sketchup-diffusion) include generative AI features directly inside the design environment.
...
Tools such as [Autodesk Forma](https://www.autodesk.com/products/forma/product-details) and Cove.tool allow architects to bring performance information into the design conversation, including:
