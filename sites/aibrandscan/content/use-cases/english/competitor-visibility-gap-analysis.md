...
draft: false
article_style: true
eyebrow: "Find where competitors win in AI answers"
section_links:
  - label: "The gap"
    href: "#what-is-a-competitor-visibility-gap"
  - label: "How it helps"
    href: "#how-ai-brand-scan-helps"
  - label: "What to measure"
    href: "#what-you-can-measure"
  - label: "Buyer prompts"
    href: "#the-buyer-questions-that-reveal-competitor-gaps"
  - label: "GEO roadmap"
    href: "#turn-competitor-gaps-into-a-geo-roadmap"
  - label: "Reporting"
    href: "#monthly-competitor-visibility-reporting"
highlights:
  - title: "Prompt-level gaps"
    description: "See exactly where competitors appear and your brand is absent."
  - title: "Competitive Share of Voice"
    description: "Compare mentions, recommendations, positioning, and citations."
  - title: "Clear next actions"
    description: "Turn competitor advantages into a focused GEO roadmap."
software: "AI Brand Scan"
workflow: "Competitor visibility gap analysis"
rendering_intent: "Competitive intelligence, positioning and GEO planning"
steps: []
preserved: []
faq: []
cta:
  enable: true
  title: "Find the gaps before they cost you pipeline"
  description: "See where AI mentions competitors instead of your brand, which prompts matter most, and what content gaps may be limiting your visibility."
  label: "Find your competitor visibility gaps"
