...
function determinePaths() {
  const themePath = path.join(selectedSite.configDir, "theme.json");
  const outputPath = selectedSite.generatedThemePath;
...
function generateThemeCSS() {
  ...
  try {
    ...
    const cssLines = [
      "/**",
      ` * Auto-generated from "sites/${selectedSite.id}/config/theme.json"`,
